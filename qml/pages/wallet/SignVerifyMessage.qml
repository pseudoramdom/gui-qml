...
Page {
    ...
    header: NavigationBar2 {
        ...
        centerItem: Header {
            headerBold: true
            headerSize: 18
            header: qsTr("Sign/Verify Message")
        }
    }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ContinueButton {
                            ...
                            text: qsTr("Sign Message")
                            enabled: root.signVerifyModel && root.signVerifyModel.isLegacyP2PKHAddress(signAddress.text) && signMessageText.text.length > 0
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ContinueButton {
                            ...
                            text: qsTr("Verify Message")
                            enabled: root.signVerifyModel && root.signVerifyModel.isLegacyP2PKHAddress(verifyAddress.text) && verifyMessageText.text.length > 0 && verifySignature.text.length > 0
                    ...
                    Rectangle {
                        ...
                        color: root.verifyResultSuccess ? Theme.color.green : Theme.color.red
                        radius: 5
                        ...
                        RowLayout {
                            ...
                            Icon {
                                id: resultIcon
                                source: root.verifyResultSuccess ? "image://images/check" : "image://images/info-filled"
                            ...
                            CoreText {
                                id: resultText
                                objectName: "verifyMessageResultText"
                                Layout.fillWidth: true
